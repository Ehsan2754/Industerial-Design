...
; 0000 0040 // Function: Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0041 DDRC=(0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 0042 // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0043 PORTC=(0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 0044 
...
; 0000 004E TCCR0=(0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 0073 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0074 
...
; 0000 008B ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 008C ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
_0xB:
; 0000 009E 
; 0000 009F      if (input[0] < 208) OUTA = 1;
	LDS  R26,_input
	CPI  R26,LOW(0xD0)
	BRSH _0xC
	SBI  0x18,0
; 0000 00A0      if (input[0] > 209) OUTA = 0;
_0xC:
	LDS  R26,_input
	CPI  R26,LOW(0xD2)
	BRLO _0xF
	CBI  0x18,0
; 0000 00A1      if (input[1] < 203) OUTB = 1;
_0xF:
	__GETB2MN _input,1
	CPI  R26,LOW(0xCB)
	BRSH _0x12
	SBI  0x18,1
; 0000 00A2      if (input[1] > 204) OUTB = 0;
_0x12:
	__GETB2MN _input,1
	CPI  R26,LOW(0xCD)
	BRLO _0x15
	CBI  0x18,1
; 0000 00A3      if (input[2] < 110) OUTC = 1;
_0x15:
	__GETB2MN _input,2
	CPI  R26,LOW(0x6E)
	BRSH _0x18
	SBI  0x18,2
; 0000 00A4      if (input[2] > 109) OUTC = 0;
_0x18:
	__GETB2MN _input,2
	CPI  R26,LOW(0x6E)
	BRLO _0x1B
	CBI  0x18,2
; 0000 00A5          // else {OUTA = OUTB = OUTC = 0;}
; 0000 00A6 
