...
_0x0:
	.DB  0x24,0x3D,0x3D,0x3D,0x3D,0x3D,0x3D,0x3D
	.DB  0x3D,0x3D,0x3D,0x3D,0x3D,0x3D,0x3D,0x3D
	.DB  0x3D,0x3D,0x3D,0x24,0x0,0x24,0x7C,0x4B
	.DB  0x41,0x4D,0x59,0x41,0x42,0x20,0x2D,0x20
	.DB  0x50,0x52,0x4F,0x4A,0x45,0x43,0x54,0x7C
	.DB  0x24,0x0,0x24,0x7C,0x54,0x65,0x6D,0x70
	.DB  0x65,0x72,0x74,0x75,0x72,0x65,0x2D,0x52
	.DB  0x46,0x43,0x6F,0x6E,0x7C,0x24,0x0,0x74
	.DB  0x65,0x6D,0x70,0x65,0x72,0x74,0x75,0x72
	.DB  0x65,0x20,0x20,0x69,0x73,0x20,0x3A,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00EE // Communication Parameters: 8 Data, 1 Stop, No Parity
...
; 0000 00F4 UCSRB=(1<<RXCIE) | (1<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(216)
	OUT  0xA,R30
; 0000 00F5 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
...
; 0000 0111 // RS - PORTC Bit 5
; 0000 0112 // RD - PORTB Bit 1
; 0000 0113 // EN - PORTC Bit 4
; 0000 0114 // D4 - PORTC Bit 3
; 0000 0115 // D5 - PORTC Bit 2
; 0000 0116 // D6 - PORTC Bit 1
; 0000 0117 // D7 - PORTC Bit 0
; 0000 0118 // Characters/line: 16
; 0000 0119 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 011A 
...
;void get_data()
; 0000 011F {      int i =0;
; 0000 0120     for(i = 0; i <20 ; i++)
;	i -> R16,R17
; 0000 0121     {
; 0000 0122         data_buf[i] = '';
; 0000 0123     }
; 0000 0124      data_buf [0] = '\0';
; 0000 0125     for    (i = 0 ; i<20 ; i++)
; 0000 0126     {
; 0000 0127 
; 0000 0128        char a = getchar();
; 0000 0129 
; 0000 012A        if (a != '#')
;	a -> Y+0
; 0000 012B        {
; 0000 012C 
; 0000 012D        data_buf[i] = a;
; 0000 012E        }
; 0000 012F        else
; 0000 0130        {
; 0000 0131        data_buf [i] =  '\0';
; 0000 0132        break;
; 0000 0133        }
; 0000 0134     }
; 0000 0135 }
...
; 0000 013B      lcd_putsf("$==================$");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 013C      lcd_putsf("$|KAMYAB - PROJECT|$");
	__POINTW2FN _0x0,21
	RCALL _lcd_putsf
; 0000 013D      lcd_putsf("$|Temperture-RFCon|$");
	__POINTW2FN _0x0,42
	RCALL _lcd_putsf
; 0000 013E      lcd_putsf("$==================$");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 013F      delay_ms(3000);
	LDI  R26,LOW(3000)
	LDI  R27,HIGH(3000)
	CALL _delay_ms
; 0000 0140  while (1)
...
; 0000 014E         lcd_gotoxy(0,0);
	...
	RCALL _lcd_gotoxy
; 0000 014F 
; 0000 0150      lcd_putsf("temperture  is :");
	__POINTW2FN _0x0,63
	RCALL _lcd_putsf
; 0000 0151      lcd_gotoxy(0,2);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(2)
	RCALL _lcd_gotoxy
; 0000 0152      lcd_puts(in);
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 0153      /* for    (j = 1 ; j<4 ; j++){
; 0000 0154       lcd_gotoxy(0,j);
; 0000 0155       lcd_putsf("                    ");   }
; 0000 0156       lcd_gotoxy(0,1);
; 0000 0157        lcd_puts(data_buf);          */
; 0000 0158 
; 0000 0159 
; 0000 015A       }
	ADIW R28,6
