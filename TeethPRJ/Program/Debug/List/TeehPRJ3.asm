...
; 0000 0073 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 0079 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 0085 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0086 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0087 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0088 
; 0000 0089 // Port E initialization
; 0000 008A // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 008B DDRE=(0<<DDE7) | (0<<DDE6) | (0<<DDE5) | (0<<DDE4) | (1<<DDE3) | (1<<DDE2) | (1<<DDE1) | (1<<DDE0);
	LDI  R30,LOW(15)
	OUT  0x2,R30
; 0000 008C // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 008D PORTE=(1<<PORTE7) | (1<<PORTE6) | (1<<PORTE5) | (1<<PORTE4) | (0<<PORTE3) | (0<<PORTE2) | (0<<PORTE1) | (0<<PORTE0);
	LDI  R30,LOW(240)
	OUT  0x3,R30
; 0000 008E 
; 0000 008F // Port F initialization
; 0000 0090 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0091 DDRF=(1<<DDF7) | (1<<DDF6) | (1<<DDF5) | (1<<DDF4) | (1<<DDF3) | (1<<DDF2) | (1<<DDF1) | (1<<DDF0);
	LDI  R30,LOW(255)
	STS  97,R30
; 0000 0092 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0093 PORTF=(0<<PORTF7) | (0<<PORTF6) | (0<<PORTF5) | (0<<PORTF4) | (0<<PORTF3) | (0<<PORTF2) | (0<<PORTF1) | (0<<PORTF0);
	LDI  R30,LOW(0)
	STS  98,R30
; 0000 0094 
; 0000 0095 // Port G initialization
; 0000 0096 // Function: Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0097 DDRG=(1<<DDG4) | (1<<DDG3) | (1<<DDG2) | (1<<DDG1) | (1<<DDG0);
	LDI  R30,LOW(31)
	STS  100,R30
; 0000 0098 // State: Bit4=1 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0099 PORTG=(1<<PORTG4) | (0<<PORTG3) | (0<<PORTG2) | (0<<PORTG1) | (0<<PORTG0);
	LDI  R30,LOW(16)
	STS  101,R30
; 0000 009A 
; 0000 009B // Timer/Counter 0 initialization
; 0000 009C // Clock source: System Clock
; 0000 009D // Clock value: 62.500 kHz
; 0000 009E // Mode: Normal top=0xFF
; 0000 009F // OC0 output: Disconnected
; 0000 00A0 // Timer Period: 4.096 ms
; 0000 00A1 ASSR=0<<AS0;
	LDI  R30,LOW(0)
	OUT  0x30,R30
...
; 0000 00B5 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 00B6 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(1)
	OUT  0x2E,R30
...
; 0000 00BE OCR1BL=0x00;
	OUT  0x28,R30
; 0000 00BF OCR1CH=0x00;
	STS  121,R30
; 0000 00C0 OCR1CL=0x00;
	STS  120,R30
; 0000 00C1 
...
; 0000 00C7 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00C9 OCR2=0x00;
	OUT  0x23,R30
; 0000 00CA 
; 0000 00CB // Timer/Counter 3 initialization
; 0000 00CC // Clock source: System Clock
; 0000 00CD // Clock value: Timer3 Stopped
; 0000 00CE // Mode: Normal top=0xFFFF
; 0000 00CF // OC3A output: Disconnected
; 0000 00D0 // OC3B output: Disconnected
; 0000 00D1 // OC3C output: Disconnected
; 0000 00D2 // Noise Canceler: Off
; 0000 00D3 // Input Capture on Falling Edge
; 0000 00D4 // Timer3 Overflow Interrupt: Off
; 0000 00D5 // Input Capture Interrupt: Off
; 0000 00D6 // Compare A Match Interrupt: Off
; 0000 00D7 // Compare B Match Interrupt: Off
; 0000 00D8 // Compare C Match Interrupt: Off
; 0000 00D9 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 00DA TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 00DB TCNT3H=0x00;
	STS  137,R30
; 0000 00DC TCNT3L=0x00;
	STS  136,R30
; 0000 00DD ICR3H=0x00;
	STS  129,R30
; 0000 00DE ICR3L=0x00;
	STS  128,R30
; 0000 00DF OCR3AH=0x00;
	STS  135,R30
; 0000 00E0 OCR3AL=0x00;
	STS  134,R30
; 0000 00E1 OCR3BH=0x00;
	STS  133,R30
; 0000 00E2 OCR3BL=0x00;
	STS  132,R30
; 0000 00E3 OCR3CH=0x00;
	STS  131,R30
; 0000 00E4 OCR3CL=0x00;
	STS  130,R30
; 0000 00E5 
; 0000 00E6 // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 00E7 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (1<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(7)
	OUT  0x37,R30
; 0000 00E8 ETIMSK=(0<<TICIE3) | (0<<OCIE3A) | (0<<OCIE3B) | (0<<TOIE3) | (0<<OCIE3C) | (0<<OCIE1C);
	LDI  R30,LOW(0)
	STS  125,R30
; 0000 00E9 
; 0000 00EA // External Interrupt(s) initialization
; 0000 00EB // INT0: On
; 0000 00EC // INT0 Mode: Low level
; 0000 00ED // INT1: On
; 0000 00EE // INT1 Mode: Low level
; 0000 00EF // INT2: On
; 0000 00F0 // INT2 Mode: Low level
; 0000 00F1 // INT3: On
; 0000 00F2 // INT3 Mode: Low level
; 0000 00F3 // INT4: On
; 0000 00F4 // INT4 Mode: Low level
; 0000 00F5 // INT5: On
; 0000 00F6 // INT5 Mode: Low level
; 0000 00F7 // INT6: On
; 0000 00F8 // INT6 Mode: Low level
; 0000 00F9 // INT7: On
; 0000 00FA // INT7 Mode: Low level
; 0000 00FB EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 00FC EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00FD EIMSK=(1<<INT7) | (1<<INT6) | (1<<INT5) | (1<<INT4) | (1<<INT3) | (1<<INT2) | (1<<INT1) | (1<<INT0);
	LDI  R30,LOW(255)
	OUT  0x39,R30
; 0000 00FE EIFR=(1<<INTF7) | (1<<INTF6) | (1<<INTF5) | (1<<INTF4) | (1<<INTF3) | (1<<INTF2) | (1<<INTF1) | (1<<INTF0);
	OUT  0x38,R30
; 0000 00FF 
