...
flash char no   [11] = {0b00000011,0b10011111,0b00100101,0b00001101,0b10011001,0b01001001,0b01000001,0b00011111,0b00000001,0b00001001,0xff};
int digit [4] = {0,1,2,3};
int k = 0,z=0;
